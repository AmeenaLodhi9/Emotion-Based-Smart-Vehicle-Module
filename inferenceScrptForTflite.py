...
# Assuming your model file is in the "trained model" folder and is named "emotion_detection_model_100epochs_no_opt.tflite"
model_folder = "trained model"
model_filename = "emotion_detection_model_100epochs_no_opt.tflite"
model_path = os.path.join(model_folder, model_filename)

# Load the TFLite model and allocate tensors.
emotion_interpreter = tf.lite.Interpreter(model_path=model_path)
