...
# Capture video from USB webcam (usually at /dev/video0)
...
# Display video window immediately
cv2.namedWindow('Emotion and Drowsiness Detector')

# Wait for 30 seconds before starting detection
start_time = time.time()
print("Waiting for 30 seconds before starting detection...")
...
while True:
    ...
    if elapsed_time >= 30:
        ...
        for (x, y, w, h) in faces:
            ...
            # Log the detected emotion (overwrite previous log)
            log_emotion(emotion_label)
